...
@section('title', 'Nueva Categoría - Flash Car')
        ...
        <div class="container">
            <div class="col-12 d-flex align-items-center justify-content-start flex-wrap rounded cont_base my-2">
                <div class="col-12 d-flex align-items-start justify-content-center flex-column p-2 bg_gris_8">
                    <h1 class="fs-6 text_uppcase">Nueva Categoría</h1>
                ...
                <form class="col-12 d-flex align-items-center justify-content-start flex-wrap" method="POST" action="{{ route('categorias.store') }}">
                @csrf
                ...
                <div class="col-12 d-flex align-items-center justify-content-start flex-wrap p-1">
                    <div class="col-12 col-sm-12 col-md-6 fila_form_f_b py-2">
                        ...
                        <input class="input_form_f_b fs-6 p-1" type="text" name="name" value="{{ old('name') }}" placeholder="Ej: Sedán, SUV, Camioneta" required autofocus>
                    </div>
                </div>
                ...
                <div class="col-12 d-flex align-items-center justify-content-start flex-wrap p-1">
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 fila_form_f_b py-2">
                        ...
                        <input class="input_form_f_b fs-6 p-1" type="number" name="price_per_day" value="{{ old('price_per_day') }}" step="0.01" min="0" required>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 fila_form_f_b py-2">
                        <label class="label_form_f_b fs-6 p-1"><b>Precio por Semana *</b></label>
                        <input class="input_form_f_b fs-6 p-1" type="number" name="price_per_week" value="{{ old('price_per_week') }}" step="0.01" min="0" required>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 fila_form_f_b py-2">
                        <label class="label_form_f_b fs-6 p-1"><b>Precio por Mes *</b></label>
                        <input class="input_form_f_b fs-6 p-1" type="number" name="price_per_month" value="{{ old('price_per_month') }}" step="0.01" min="0" required>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 col-lg-3 fila_form_f_b py-2">
                        <label class="label_form_f_b fs-6 p-1"><b>Garantía *</b></label>
                        <input class="input_form_f_b fs-6 p-1" type="number" name="warranty" value="{{ old('warranty') }}" step="0.01" min="0" required>
                    </div>
                </div>
